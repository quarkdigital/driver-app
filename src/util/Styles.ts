...
export const FF = StyleSheet.create({
...
export const txtCLR = StyleSheet.create({
	...
	darkGray: { color: "#242A34" },
	gray: { color: "#343C4B" },
});

export const CLR = StyleSheet.create({
	darkBlue: { backgroundColor: "#1C2129" },
	lightGreen: { backgroundColor: "#80F17E" },
	darkGray: { backgroundColor: "#242A34" },
	gray: { backgroundColor: "#343C4B" },
});
